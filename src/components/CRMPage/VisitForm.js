...
function VisitForm(props) {
  ...
  const submitHandler = (event) => {
    ...
    if (userName === "") return alert("고객 성함을 입력해주세요.");
    ...
    axios
      ...
      .then((response) => {
        ...
        } else alert("방문 고객 목록 추가가 실패했습니다.");
      })
      .catch((err) => {
              ...
              <div className="px-6 py-6 lg:px-8">
                ...
                <form className="space-y-6" onSubmit={submitHandler}>
                  <div>
                    ...
                    >
                      고객 성함<span className="text-red-600 font-bold">*</span>
                    </label>
                    <input
                      type="text"
                      id="userName"
                  ...
                  <div>
                    <label
                      ...
                      className="block mb-2 text-sm font-medium text-gray-900 dark:text-white"
                    >
                      고객 메모<span className="text-red-600 font-bold">*</span>
                    </label>
                    <textarea
                      id="memo"
                      placeholder="고객 메모"
