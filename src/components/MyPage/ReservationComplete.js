...
function ReservationComplete(props) {
  ...
  const completeHandler = () => {
    ...
    let reservationInfo = {
      reservation_id: props.target.reservationId,
    };

    const formData = new FormData();
    formData.append("jsonList", JSON.stringify(reservationInfo));

    axios
      .put(API + "/reservation/finish", formData, {
        headers: {
